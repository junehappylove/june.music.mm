...
public class FlacTagReader {
	...
	public FlacTag read(RandomAccessFile raf) throws CannotReadException, IOException {
		...
		while (!isLastBlock) {
			...
			// Is it one containing some sort of metadata, therefore interested
			// in it?
			...
			// This is not a metadata block we are interested in so we skip to
			// next block
			default:
		...
		// Note there may not be either a tag or any images, no problem this is
		// valid however to make it easier we
