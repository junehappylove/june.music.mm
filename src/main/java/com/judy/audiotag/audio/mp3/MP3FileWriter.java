...
/**
 * Write Mp3 Info (retrofitted to entagged ,done differently to entagged which
 * is why some methods throw RuntimeException) because done elsewhere
 */
public class MP3FileWriter extends AudioFileWriter {
	public void deleteTag(AudioFile f) throws CannotWriteException {
		...
		// taking into account if the tag has been sent to null in which case it
		// will be deleted
		f.commit();
	}
