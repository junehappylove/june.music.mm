...
/**
 * Thrown if the tag o isn't found. This is different from the
 * <code>InvalidTagException</code>. Each tag has an ID string or some way
 * saying that it simply exists. If this string is missing,
