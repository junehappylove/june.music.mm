 ...
 *
 * <p>
 * This is the IDv1 list with additional values as defined by Winamp, this list
 * is also used in Mp4 files, note iTunes doesnt understand genres above
 * MAX_STANDARD_GENRE_ID, Winamp does
 * </p>
 */
public class GenreTypes extends AbstractIntStringValuePair<Integer> {
	private static int MAX_STANDARD_GENRE_ID = 125;

	/**
	 * @return the maximum genreId that is part of the official Standard, genres
	 *         above this were added by winamp later.
	 */
