...
import com.judy.audiotag.tag.datatype.AbstractStringStringValuePair;
...
public abstract class ID3Frames extends AbstractStringStringValuePair {
	...
	private static void loadID3v23ID3v24Mapping() {
		...
		// This one way allows us to convert XSOT to TSOT,XSOP to TSOP and XSOA
		// - TSOA but in the other direction gets converted to TSOT,TSOP,TSOA
		convertv23Tov24.put(ID3v23Frames.FRAME_ID_V3_TITLE_SORT_ORDER_MUSICBRAINZ,
				ID3v24Frames.FRAME_ID_TITLE_SORT_ORDER);
		convertv23Tov24.put(ID3v23Frames.FRAME_ID_V3_ARTIST_SORT_ORDER_MUSICBRAINZ,
				ID3v24Frames.FRAME_ID_ARTIST_SORT_ORDER);
		convertv23Tov24.put(ID3v23Frames.FRAME_ID_V3_ALBUM_SORT_ORDER_MUSICBRAINZ,
				ID3v24Frames.FRAME_ID_ALBUM_SORT_ORDER);

		// No others exist because most v23 mappings are identical to v24
		// therefore no mapping required and the ones that
		// are different need to be forced.

		// Force v23 to v24 These are deprecated and need to do a forced mapping
		forcev23Tov24.put(ID3v23Frames.FRAME_ID_V3_RELATIVE_VOLUME_ADJUSTMENT,
	...
	private static void loadID3v22ID3v23Mapping() {
		...
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_GENERAL_ENCAPS_OBJECT,
		...
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_MPEG_LOCATION_LOOKUP_TABLE,
		...
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_RECOMMENDED_BUFFER_SIZE,
				ID3v23Frames.FRAME_ID_V3_RECOMMENDED_BUFFER_SIZE);
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_RECOMMENDED_BUFFER_SIZE,
				ID3v23Frames.FRAME_ID_V3_RECOMMENDED_BUFFER_SIZE);
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_RELATIVE_VOLUME_ADJUSTMENT,
				ID3v23Frames.FRAME_ID_V3_RELATIVE_VOLUME_ADJUSTMENT);
		...
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_TITLE_SORT_ORDER_ITUNES,
				ID3v23Frames.FRAME_ID_V3_TITLE_SORT_ORDER_ITUNES);
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_ARTIST_SORT_ORDER_ITUNES,
				ID3v23Frames.FRAME_ID_V3_ARTIST_SORT_ORDER_ITUNES);
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_ALBUM_SORT_ORDER_ITUNES,
				ID3v23Frames.FRAME_ID_V3_ALBUM_SORT_ORDER_ITUNES);
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_ALBUM_ARTIST_SORT_ORDER_ITUNES,
				ID3v23Frames.FRAME_ID_V3_ALBUM_ARTIST_SORT_ORDER_ITUNES);
		convertv22Tov23.put(ID3v22Frames.FRAME_ID_V2_COMPOSER_SORT_ORDER_ITUNES,
		...
		// This one way translation allows us to convert XSOT to TST, but in the
		// other direction gets converted to TSOT
		convertv23Tov22.put(ID3v23Frames.FRAME_ID_V3_TITLE_SORT_ORDER_MUSICBRAINZ,
				ID3v22Frames.FRAME_ID_V2_TITLE_SORT_ORDER_ITUNES);
		convertv23Tov22.put(ID3v23Frames.FRAME_ID_V3_ARTIST_SORT_ORDER_MUSICBRAINZ,
				ID3v22Frames.FRAME_ID_V2_ARTIST_SORT_ORDER_ITUNES);
		convertv23Tov22.put(ID3v23Frames.FRAME_ID_V3_ALBUM_SORT_ORDER_MUSICBRAINZ,
