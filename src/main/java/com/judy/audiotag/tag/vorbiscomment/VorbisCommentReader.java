 ...
 *
 * <p>
 * This is in the same format whether encoded with Ogg or Flac except the
 * framing bit is only present when used within Ogg Vorbis
 *
 * <pre>
...
public class VorbisCommentReader {
	...
	public VorbisCommentTag read(byte[] rawdata, boolean isFramingBit) throws IOException, CannotReadException {
		...
		// Check framing bit, only exists when vorbisComment used within
		// OggVorbis
		if (isFramingBit) {
