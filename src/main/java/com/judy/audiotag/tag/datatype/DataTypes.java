...
public class DataTypes {
	/**
	 * Represents a text encoding, now only IDv2Frames not Lyrics3 tags use text
	 * encoding objects but both use Object Strings and these check for a text
	 * encoding. The method below returns a default if one not set.
	 */
