...
/**
 * Represents a String which is not delimited by null character with fixed text
 * encoding.
 * 
 ...
 * when writing the frame will accomodate the required size for the String. The
