...
/**
 * Represents a datatype that allow multiple Strings but they should be paired,
 * i.e should be 2,4,6.. Strings
 *
...
public class PairedTextEncodedStringNullTerminated extends MultipleTextEncodedStringNullTerminated {
	 ...
	 *             if unable to find any null terminated Strings or if find odd
	 *             number of Strings
	 */
	...
	/**
	 * This holds the values held by this PairedTextEncodedDatatype, always held
	 * as pairs of values
	 */
