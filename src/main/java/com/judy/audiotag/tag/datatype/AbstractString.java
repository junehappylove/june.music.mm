...
public abstract class AbstractString extends AbstractDataType {
	...
	/**
	 * Sets the size in bytes of this datatype. This is set after writing the
	 * data to allow us to recalculate the size for frame header.
	 *
	 */
	...
	public boolean canBeEncoded() {
		// Try and write to buffer using the CharSet defined by the textEncoding
		// field.
