...
import com.judy.momoplayer.tag.TagInfo;
import com.judy.momoplayer.tag.TagInfoFactory;
import com.judy.momoplayer.util.Config;
import com.judy.momoplayer.util.FileUtil;
...
/**
 * This class implements item for playlist. PlayListItem <br>
 * 
 * @author 王俊伟 wjw.happy.love@163.com
 * @blog https://www.github.com/junehappylove
 * @date 2017年1月12日 下午8:52:37
 * @version 1.0.0
 */
public class PlayListItem implements Serializable {

	private static final long serialVersionUID = 20071213L;
	private static final Logger log = Logger.getLogger(PlayListItem.class.getName());
	...
	public void reRead() {
		...
		displayName = getFormattedDisplayName();
		log.log(Level.INFO, "setDisPlay={0}", displayName);
	}
	...
	public String getFormattedDisplayName() {
		if (artist != null && title != null) {
			...
			if ((taginfo.getTitle() != null) && (!taginfo.getTitle().trim().equals("")) && (taginfo.getArtist() != null)
					&& (!taginfo.getArtist().trim().equals(""))) {
				log.log(Level.INFO, "name={0}", name);
				log.log(Level.INFO, "artist={0}", taginfo.getArtist());
				log.log(Level.INFO, "title={0}", taginfo.getTitle());
	...
	public void setFormattedDisplayName(String fname) {
		log.log(Level.INFO, "************setFormatedName:{0}", fname);
		displayName = fname;
	}
