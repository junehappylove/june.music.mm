...
public abstract class AbstractBitmapIndexed extends AbstractBitmap {
	...
	public BufferedImage createImageIndexed() {
		...
		final BufferedImage lImage = new BufferedImage(getWidth(), getHeight(), BufferedImage.TYPE_BYTE_INDEXED,
				lModel);
	...
	public BufferedImage createImageRGB() {
		final BufferedImage lImage = new BufferedImage(getWidth(), getHeight(), BufferedImage.TYPE_INT_ARGB);
	...
	public Color getColor(final int pIndex) {
		if (pIndex >= getVerifiedColorCount()) {
			throw new IllegalArgumentException(
					"Color index out of range: is " + pIndex + ", max. " + getVerifiedColorCount());
		}
