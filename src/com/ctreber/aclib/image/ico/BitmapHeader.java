...
public class BitmapHeader {
	...
	public String toString() {
		return "size: " + _headerSize + ", width: " + _width + ", height: " + _height + ", planes: " + _planes
				+ ", BPP: " + _bpp + ", compression: " + _compression + ", imageSize: " + _imageSize + ", XPixelsPerM: "
				+ _xPixelsPerM + ", YPixelsPerM: " + _yPixelsPerM + ", colorsUsed: " + _colorsUsed
				+ ", colorsImportant: " + _colorsImportant + (_colorsImportant == 0 ? " (all)" : "");
	}
