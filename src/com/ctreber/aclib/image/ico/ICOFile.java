...
public class ICOFile implements Comparable<Object> {
	 ...
	 * @throws IOException
	 */
	private void fillDescriptors(final AbstractDecoder pDec, final BitmapDescriptor[] pDescriptors) throws IOException {
	 ...
	 * @throws IOException
	 */
	private void fillDescriptor(final AbstractDecoder pDec, final BitmapDescriptor pDescriptor) throws IOException {
