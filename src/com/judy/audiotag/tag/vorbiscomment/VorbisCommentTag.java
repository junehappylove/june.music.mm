...
public class VorbisCommentTag extends AbstractTag {
	...
	static EnumMap<TagFieldKey, VorbisCommentFieldKey> tagFieldToOggField = new EnumMap<TagFieldKey, VorbisCommentFieldKey>(
			TagFieldKey.class);
	...
	static {
		...
		tagFieldToOggField.put(TagFieldKey.MUSICBRAINZ_RELEASEARTISTID,
		...
		tagFieldToOggField.put(TagFieldKey.ENCODER, VorbisCommentFieldKey.VENDOR); // Known
																					// as
																					// vendor
																					// in
																					// VorbisComment
	...
	// Should be the name of the software
	 ...
	 *
	 * We dont want this to be blank, when written to file this field is written
	 * to a different location to all other fields but user of library can just
	 * reat it as another field
	 * 
	 * @param vendor
	 */
	 ...
	 * Create Tag Field using ogg key
	 *
	 * This method is provided to allow you to create key of any value because
	 * VorbisComment allows arbitary keys.
	 *
	 * @param vorbisCommentFieldKey
	 * @param value
	 * @return
	...
	/**
	 * Maps the generic key to the ogg key and return the list of values for
	 * this field
	 *
	 * @param genericKey
	 */
	 ...
	 *            mimeType of data
	 *
	 *            TODO could possibly work out mimetype from data, but unlike
	 *            mp4 there is nothing to restrict to only png or jpeg images
	 * 
	 * @return
	 */
	public void setArtworkField(byte[] data, String mimeType) {
		...
		VorbisCommentTagField mimeField = new VorbisCommentTagField(VorbisCommentFieldKey.COVERARTMIME.name(),
				mimeType);
	 ...
	 *
	 * <p>
	 * Overridden because check for size of one because there is always a vendor
	 * tag unless just created an empty vorbis tag as part of flac tag in which
	 * case size could be zero
	 * 
