...
public class VorbisCommentTagField implements TagTextField {
	...
	private void checkCommon() {
		this.common = id.equals(TITLE.name()) || id.equals(ALBUM.name()) || id.equals(ARTIST.name())
				|| id.equals(GENRE.name()) || id.equals(TRACKNUMBER.name()) || id.equals(DATE.name())
				|| id.equals(DESCRIPTION.name()) || id.equals(COMMENT.name());
	 ...
	 * @return If <code>encoding</code> is supported the byte data of the given
	 *         string is returned in that encoding.
	 * @throws UnsupportedEncodingException
	...
	public void setEncoding(String s) {
		if (s == null || !s.equalsIgnoreCase("UTF-8")) {
			throw new UnsupportedOperationException(
					"The encoding of OggTagFields cannot be " + "changed.(specified to be UTF-8)");
		}
	}
