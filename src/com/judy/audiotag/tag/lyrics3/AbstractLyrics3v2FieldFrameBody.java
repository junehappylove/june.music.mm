...
public abstract class AbstractLyrics3v2FieldFrameBody extends AbstractTagFrameBody {
	...
	/**
	 * This reads a frame body from its file into the appropriate FrameBody
	 * class Read the data from the given file into this datatype. The file
	 * needs to have its file pointer in the correct location. The size as
	 * indicated in the header is passed to the frame constructor when reading
	 * from file.
	 *
	 * @param byteBuffer
	 *            file to read
