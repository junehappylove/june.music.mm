...
/**
 * Represents a field/data type that can be held within a frames body, these map
 * loosely onto Section 4. ID3v2 frame overview at
...
public abstract class AbstractDataType extends java.lang.Object {
	...
	// Logger
	public static Logger logger = Logger.getLogger("com.judy.jaudiotagger.tag.datatype");
	...
	/**
	 * Holds the key such as "Text" or "PictureType", the naming of keys are
	 * fairly arbitary but are intended to make it easier to for the developer,
	 * the keys themseleves are not written to the tag.
	 */
	...
	/**
	 * Construct an abstract datatype identified by identifier and linked to a
	 * framebody without setting an initial value.
	 *
	 * @param identifier
	...
	/**
	 * Construct an abstract datatype identified by identifier and linked to a
	 * framebody initilised with a value
	 *
	 * @param identifier
	 *            to allow retrieval of this datatype by name from framebody
	 * @param frameBody
	...
	/**
	 * Simplified wrapper for reading bytes from file into Object. Used for
	 * reading Strings, this class should be overridden for non String Objects
	 *
	 * @param arr
	 */
	...
	/**
	 * This defines the size in bytes of the datatype being held when
	 * read/written to file.
	 *
	...
	/**
	 * This is the starting point for reading bytes from the file into the ID3
	 * datatype starting at offset. This class must be overridden
	 *
	 * @param arr
	 * @param offset
	 */
	...
	/**
	 * Starting point write ID3 Datatype back to array of bytes. This class must
	 * be overridden.
	 *
	 * @return the array of bytes representing this datatype that should be
	 *         written to file
	 */
