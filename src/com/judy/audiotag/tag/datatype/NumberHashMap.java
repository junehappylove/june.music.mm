...
import com.judy.audiotag.tag.id3.valuepair.ChannelTypes;
import com.judy.audiotag.tag.id3.valuepair.EventTimingTimestampTypes;
import com.judy.audiotag.tag.id3.valuepair.EventTimingTypes;
import com.judy.audiotag.tag.id3.valuepair.GenreTypes;
import com.judy.audiotag.tag.id3.valuepair.InterpolationTypes;
import com.judy.audiotag.tag.id3.valuepair.PictureTypes;
import com.judy.audiotag.tag.id3.valuepair.ReceivedAsTypes;
import com.judy.audiotag.tag.id3.valuepair.SynchronisedLyricsContentType;
...
public class NumberHashMap extends NumberFixedLength implements HashMapInterface {
	 ...
	 * key to value map
	 */
	private Map<?, String> keyToValue = null;
		...
		if (hasEmptyValue == false) {
			...
			if (!keyToValue.containsKey(intValue)) {
				throw new InvalidDataTypeException(
						this.getClass().getName() + ":No key could be found with the value of:" + intValue);
			}
		}
	}
