...
public class ID3v24Tag extends AbstractID3v2Tag {
	 ...
	 */
	public ID3v24Tag() {
		frameMap = new LinkedHashMap<String, Object>();// new
														// LinkedHashMap<String,
														// Serializable>();
	}

	/**
	 * Copy primitives applicable to v2.4, this is used when cloning a v2.4
	 * datatype and other objects such as v2.3 so need to check instanceof
	 */
	...
	public ID3v24Tag(AbstractTag mp3tag) {
		...
		if (mp3tag != null) {
			...
			/*
			 * If we get a tag, we want to convert to id3v2_4 both id3v1 and
			 * lyrics3 convert to this type id3v1 needs to convert to id3v2_4
			 * before converting to lyrics3
			 */
	...
	/**
	 * Return tag size based upon the sizes of the frames rather than the
	...
	/**
	 * Read Tag from Specified file. Read tag header, delegate reading of frames
	 * to readFrames()
	 *
	 * @param byteBuffer
	 ...
	 * <p/>
	 * <p>
	 * Because synchronization occurs at the frame level it is not normally
	 * desirable to unsynchronize all frames and hence this flag is not normally
	 * set.
	 *
