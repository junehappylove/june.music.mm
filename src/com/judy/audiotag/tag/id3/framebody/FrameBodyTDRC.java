...
public class FrameBodyTDRC extends AbstractFrameBodyTextInfo implements ID3v24FrameBody {
	...
	/**
	 * When this has been generated as an amalgamation of v3 frames assumes the
	 * v3 frames match the the format in specification and convert them to their
	 * equivalent v4 format and return the generated String. i.e if the v3
	 * frames contain a valid value this will return a valid v4 value, if not
	 * this won't.
	 */
