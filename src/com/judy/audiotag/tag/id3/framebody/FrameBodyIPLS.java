 ...
 * in each tag.
 *
 * <Header for 'Involved people list', ID: "IPLS"> Text encoding $xx People list
 * strings <text strings according to encoding>
 * 
 * <p>
 ...
 *
 * @TODO currently just allows any number of values, should only really support
 *       pairs of values
 */
public class FrameBodyIPLS extends AbstractID3v2FrameBody implements ID3v23FrameBody {
	...
	/**
	 * Because have a text encoding we need to check the data values do not
	 * contain characters that cannot be encoded in current encoding before we
	 * write data. If they do change the encoding.
	 */
	...
	/**
	 * Consists of a text encoding , and then a series of null terminated
	 * Strings, there should be an even number of Strings as they are paired as
