...
import com.judy.audiotag.tag.id3.AbstractTagFrame;
...
public abstract class AbstractTagFrameBody extends AbstractTagItem {
	...
	/**
	 * Reference to the header associated with this frame body, a framebody can
	 * be created without a header but one it is associated with a header this
	 * should be set. It is principally useful for the framebody to know its
	 * header, because this will specify its tag version and some framebodies
	 * behave slighly different between tag versions.
	 */
	...
	/**
	 * Creates a new framebody, at this point the bodys ObjectList is setup
	 * which defines what datatypes are expected in body
	 */
	...
	/**
	 * Copy Constructor for fragment body. Copies all objects in the Object
	 * Iterator with data.
	 */
	...
	/**
	 * Sets all objects of identifier type to value defined by <code>obj</code>
	 * argument.
	 *
	 * @param identifier
	...
	/**
	 * Returns true if this instance and its entire DataType array list is a
	 * subset of the argument. This class is a subset if it is the same class as
	 * the argument.
	 *
	 * @param obj
	...
	/**
	 * Returns true if this datatype and its entire DataType array list equals
	 * the argument. This datatype is equal to the argument if they are the same
	 * class.
	 *
	 * @param obj
	...
	/**
	 * Create the list of Datatypes that this body expects in the correct order
