...
/**
 * Defines ID3v23 frames and collections that categorise frames within an ID3v23
 * tag.
 *
 * You can include frames here that are not officially supported as long as they
 * can be used within an ID3v23Tag
 *
 * @author Paul Taylor
...
public class ID3v23Frames extends ID3Frames {
	/**
	 * Define all frames that are valid within ID3v23 Frame IDs begining with T
	 * are text frames, & with W are url frames
	 */
	 ...
	 */
	protected EnumMap<TagFieldKey, ID3v23FieldKey> tagFieldToId3 = new EnumMap<TagFieldKey, ID3v23FieldKey>(
			TagFieldKey.class);
