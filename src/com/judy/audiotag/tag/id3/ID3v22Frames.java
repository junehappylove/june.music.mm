...
/**
 * Defines ID3v22 frames and collections that categorise frames within an ID3v22
 * tag.
 * <p/>
 * You can include frames here that are not officially supported as long as they
 * can be used within an ID3v22Tag
 *
 * @author Paul Taylor
...
public class ID3v22Frames extends ID3Frames {
	 ...
	 */
	protected EnumMap<TagFieldKey, ID3v22FieldKey> tagFieldToId3 = new EnumMap<TagFieldKey, ID3v22FieldKey>(
			TagFieldKey.class);
