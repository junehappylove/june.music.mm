...
import com.judy.audiotag.tag.id3.valuepair.GenreTypes;
...
public class TagOptionSingleton {
	...
	/**
	 * When adjusting the ID3v2 padding, if should we copy the current ID3v2 tag
	 * to the new MP3 file. Defaults to true.
	 */
	...
	/**
	 * Unsynchronize tags/frames this is rarely required these days and can
	 * cause more problems than it solves
	 */
	private boolean unsyncTags = false;

	/**
	 * iTunes needlessly writes null terminators at the end for
	 * TextEncodedStringSizeTerminated values, if this option is enabled these
	 * characters are removed
	 */
	private boolean removeTrailingTerminatorOnWrite = true;

	/**
	 * This is the default text encoding to use for new v23 frames, when unicode
	 * is required UTF16 will always be used because that is the only valid
	 * option for v23.
	 */
	private byte id3v23DefaultTextEncoding = TextEncoding.ISO_8859_1;

	/**
	 * This is the default text encoding to use for new v24 frames, it defaults
	 * to simple ISO8859 but by changing this value you could always used UTF8
	 * for example whether you needed to or not
	 */
	private byte id3v24DefaultTextEncoding = TextEncoding.ISO_8859_1;

	/**
	 * This is text encoding to use for new v24 frames when unicode is required,
	 * it defaults to UTF16 just because this encoding is understand by all ID3
	 * versions
	 */
	 ...
	 * using the defaults disregarding the text e ncoding originally used to
	 * create the frame.
	 */
	...
	/**
	 * Returns the number of MP3 frames to sync when trying to find the start of
	 * the MP3 frame data. The start of the MP3 frame data is the start of the
	 * music and is different from the ID3v2 frame data. WinAmp 2.8 seems to
	 * sync 3 frames. Default is 5.
	 *
	...
	/**
	 * Sets the default time stamp format for ID3v2 tags which require it. While
	 * the value will already exist when reading from a file, this value will be
	 ...
	 * @throws TagException
	 */
	public void addKeyword(Class<?> id3v2FrameBodyClass, String keyword) throws TagException {
	...
	/**
	 *
	 * @return are tags unsynchronized when written if contain bit pattern that
	 *         could be mistaken for audio marker
	 */
	 ...
	 *
	 * @param unsyncTags
	 *            set whether tags are unsynchronized when written if contain
	 *            bit pattern that could be mistaken for audio marker
	 */
	...
	/**
	 * Get the default text encoding to use for new v23 frames, when unicode is
	 * required UTF16 will always be used because that is the only valid option
	 * for v23/v22
	 *
	 * @return
	 */
	...
	/**
	 * Set the default text encoding to use for new v23 frames, when unicode is
	 * required UTF16 will always be used because that is the only valid option
	 * for v23/v22
	 *
	...
	public void setId3v23DefaultTextEncoding(byte id3v23DefaultTextEncoding) {
		if ((id3v23DefaultTextEncoding == TextEncoding.ISO_8859_1)
	...
	/**
	 * Get the default text encoding to use for new v24 frames, it defaults to
	 * simple ISO8859 but by changing this value you could always used UTF8 for
	 * example whether you needed to or not
	 *
	 * @return
	 */
	...
	/**
	 * Set the default text encoding to use for new v24 frames, it defaults to
	 * simple ISO8859 but by changing this value you could always used UTF8 for
	 * example whether you needed to or not
	 *
	...
	public void setId3v24DefaultTextEncoding(byte id3v24DefaultTextEncoding) {
		if ((id3v24DefaultTextEncoding == TextEncoding.ISO_8859_1) || (id3v24DefaultTextEncoding == TextEncoding.UTF_16)
	...
	/**
	 * Get the text encoding to use for new v24 frames when unicode is required,
	 * it defaults to UTF16 just because this encoding is understand by all ID3
	 * versions
	 *
	 * @return
	...
	/**
	 * Set the text encoding to use for new v24 frames when unicode is required,
	 * it defaults to UTF16 just because this encoding is understand by all ID3
	 * versions
	 *
	...
	public void setId3v24UnicodeTextEncoding(byte id3v24UnicodeTextEncoding) {
		if ((id3v24UnicodeTextEncoding == TextEncoding.UTF_16) || (id3v24UnicodeTextEncoding == TextEncoding.UTF_16BE)
	...
	/**
	 * When writing frames if this is set to true then the frame will be written
	 * using the defaults disregarding the text encoding originally used to
	 * create the frame.
	 *
	 * @return
	 */
