...
import com.judy.audiotag.tag.vorbiscomment.VorbisCommentCreator;

/**
 * Creates an OggVorbis Comment Tag from a VorbisComment for use within an
 * OggVorbis Container
 *
 * When a Vorbis Comment is used within OggVorbis it additionally has a vorbis
 * header and a framing bit.
 */
public class OggVorbisCommentTagCreator {
	...
	public ByteBuffer convert(Tag tag) throws UnsupportedEncodingException {
		...
		int tagLength = ogg.capacity() + VorbisHeader.FIELD_PACKET_TYPE_LENGTH
				+ VorbisHeader.FIELD_CAPTURE_PATTERN_LENGTH + OggVorbisCommentTagCreator.FIELD_FRAMING_BIT_LENGTH;
